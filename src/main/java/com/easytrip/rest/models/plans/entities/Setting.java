...
public class Setting implements FoursquareEntity {
    ...
    /**
     * Returns true of false indicating if user's mayorships will be sent to
     * Twitter
     *
     * @return true of false indicating if user's mayorships will be sent to
     * Twitter
     */
    ...
    /**
     * Returns true of false indicating if user's badges will be sent to
     * Facebook
     *
     * @return true of false indicating if user's badges will be sent to
     * Facebook
     */
