...
public class Timeframe implements FoursquareEntity {
    ...
    /**
     * Returns an array of describing the named segments of the days in this
     * timeframe in which the venue is open.
     *
     * @return an array of describing the named segments of the days in this
     * timeframe in which the venue is open.
     */
