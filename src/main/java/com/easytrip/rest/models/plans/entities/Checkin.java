 ...
 *
 * @see
 * <a href="https://developer.foursquare.com/docs/responses/checkin.html" target="_blank">https://developer.foursquare.com/docs/responses/checkin.html</a>
 *
 * @author Antti Leppä
 */
public class Checkin implements FoursquareEntity {
    ...
    /**
     * Returns Location of the checkin. Field may be present if the type of this
     * checkin is shout or venueless.
     *
    ...
    /**
     * Returns Source object containing application name and url that created
     * this checkin
     *
    ...
    /**
     * Returns checkins from friends checked into the same venue around the same
     * time.
     *
     ...
     *
     * Method is needed because "private" is reserved word and thus normal field
     * access can not be used to set field value
     *
