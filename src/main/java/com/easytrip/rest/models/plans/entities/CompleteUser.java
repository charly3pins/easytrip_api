 ...
 *
 * @see
 * <a href="https://developer.foursquare.com/docs/responses/user.html" target="_blank">https://developer.foursquare.com/docs/responses/user.html</a>
 *
 * @author Antti Leppä
 */
public class CompleteUser extends CompactUser {
    ...
    /**
     * Returns the count of checkins by this user. Contains most recent checkin
     * as an array of items, if the user is a friend.
     *
    ...
    /**
     * Returns the count of mayorships by this user. Contains selected
     * mayorships as an array of items, if the user is a friend.
     *
    ...
    /**
     * Returns for count of tips by this user. Contains selected tips as an
     * array of items, if the user is friend.
     *
    ...
    /**
     * Returns for count of todos by this user. Contains selected todos as an
     * array of items, if the user is friend.
     *
