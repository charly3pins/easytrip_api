...
public class JSONFieldParser {
    ...
    /**
     * Static method that parses JSON "named array" into array of
     * FoursquareEntities
     *
     * @param clazz entity class
    ...
    /**
     * Parses single JSON object field into a value. Value might be of type
     * String, Integer, Long, Double, Boolean or FoursquareEntity depending
     * classes field type
     *
     * @param clazz class
     * @param jsonObject JSON Object
    ...
    private static Object parseValue(Class<?> clazz, JSONObject jsonObject, String objectFieldName, boolean skipNonExistingFields) throws JSONException, FoursquareApiException {
        if (clazz.isArray()) {
            ...
            } else if ((value instanceof JSONObject) && (((JSONObject) value).has("items"))) {
            ...
            throw new FoursquareApiException("Unknown type: " + clazz + " json object is " + jsonObject.toString());
        }
    }
