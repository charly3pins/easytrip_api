 ...
 *
 * @see
 * <a href="https://developer.foursquare.com/docs/responses/special.html" target="_blank">https://developer.foursquare.com/docs/responses/special.html</a>
 *
 * @author Antti Leppä
 */
...
public class CompleteSpecial implements FoursquareEntity {
    ...
    /**
     * Returns type of the venue. One of mayor, count, frequency, regular,
     * friends, swarm, flash or other.
     *
    ...
    /**
     * Returns true or false indicating if this special is unlocked for the
     * acting user.
     *
     * @return true or false indicating if this special is unlocked for the
     * acting user.
     */
     ...
     * http://foursquare.com/img/specials/<b>icon</b>.png
     *
