...
public class FlightsService {
	...
	public Response sayHello(@PathParam("originplace") String origin, @PathParam("destinationplace") String destination) throws IOException {
		String output = "Trip Resume. Origin " + origin + ", Destination: "+ destination + "!";
